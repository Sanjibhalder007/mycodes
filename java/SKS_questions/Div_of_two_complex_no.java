...
class A
{
	...
	A calculate(A p,A q)
	{
		...
		q.img=-q.img;
		temp.real=((q.real*q.real)-(q.img*q.img*-1));
		System.out.print("\n Value of Divisor"+temp.real);
		r.real=r.real/temp.real;
		r.img=r.img/temp.real;
		return(r);
	}
	void output()
	{
...
class Div_of_two_complex_no
{
	public static void main(String args[])throws IOException
	{
		...
		obj2.output();
		System.out.print("\n After Divison Complex Number Is:");
		obj3.output();
	}
}