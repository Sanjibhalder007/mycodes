...
void student_sports :: external_marks_calculate()
{
	int r=1;
	if(r==i)
	{
...
void student_sports :: external_marks_calculate_output()
{
	cout<<"\n TOTAL MARKS="<<cal;
}
int student_sports :: sports_info()
{
	int t;
